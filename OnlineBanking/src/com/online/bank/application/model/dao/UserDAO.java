...
/*Persistance Logic for UserLogin validation*/
	public RegistrationDTO getUserDetails(String AccountNo) throws SQLException {

		RegistrationDTO dto = null;

		String query = "select * from jjs6.bank where AccNo=?";
		SingleTon singleTon = SingleTon.getSingleTon();
		Connection con = singleTon.getconnection();
		...
		if (rs.next())
		{
			...
			dto.setTypeofAccount(rs.getString("typeofAccount"));
...
/*Persistance Logic for User money transfer operation*/
	...
	public boolean ValidateOTP(String AccountNo,String OTP){
		String sqlquery = "select * from jjs6.bank where AccNo=? and otp=?";

...
<div class="container">
	<div class="row justify-content-md-center" >
		   <FORM  name="myform" method="POST" ACTION="editprofile" style="margin-top: 80px;">
...
Select to update information:
	...
	<TD>
	<select  class="form-control" name = "colname" required >
...
Enter new information:
	...
	<TD><INPUT class="form-control" TYPE="text" placeholder="1000" NAME="data" required></TD>
</TR>
			<TR>
			...
			<tr>
				<td colspan="2" align="center">
					<Button type="submit" name="submit"   class="btn btn-primary btn-lg" value="UpdateInfo">Update</Button>
				</td>
				</tr>
				<TR>

...
<div class="container">
	<div class="row justify-content-md-center" >
		   <FORM  name="myform" method="POST" ACTION="Banking" style="margin-top: 80px;">
		<TABLE class="table table-striped table-dark">
				<TR>
			<TD colspan="2" align="center"><h2>Withdraw Money</h2></TD>
			</TR>
			<TR>
...
<TR>
	<TD>Withdrawal Amount in Rupees (&#8377) :</TD>
	<TD><INPUT class="form-control" TYPE="number" placeholder="1000" NAME="amt" required></TD>
</TR>
			<TR>
			...
			<tr>
				<td colspan="2" align="center">
					<Button type="submit" name="submit"   class="btn btn-primary btn-lg" value="Withdraw">Withdraw</Button>
				</td>
				</tr>
				<TR>

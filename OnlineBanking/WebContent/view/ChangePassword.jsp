...
<div class="container">
	<div class="row justify-content-md-center" >
		   <FORM  name="myform" method="POST" ACTION="changepwd" style="margin-top: 80px;">
	...
	<TD><INPUT  class="form-control" TYPE="text" placeholder="SBI-123456789" NAME="rec" value="<%=session.getAttribute("ac") %>" disabled></TD>
</TR>
<TR>
<td>
Enter Old Password:
</td>
	<TD><INPUT class="form-control" TYPE="password" placeholder="**********" NAME="old" required></TD>
</TR>
<TR>
<td>
Enter new Password:
</td>
	<TD><INPUT class="form-control" TYPE="password" placeholder="**********" NAME="pass1" required></TD>
</TR>
<tr>
<td>
Confirm new Password:
</td>
	<TD><INPUT class="form-control" TYPE="password" placeholder="**********" NAME="pass2" required></TD>
</TR>
			<TR>
			<TD colspan="2" align="center" ><h5 class="text-light text-capitalize">
			...
			<tr>
				<td colspan="2" align="center">
					<Button type="submit" name="submit"   class="btn btn-primary btn-lg" value="UpdateInfo" onSubmit="return validateForm()">Update</Button>
				</td>
				</tr>
				<TR>

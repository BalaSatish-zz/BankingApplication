...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
  ...
  <h1 class="display-4">Account Balance</h1>
   <hr class="my-4">
  <p class="">Hi   <font class="text-primary text-capitalize"><%=ref %>,</font> Your account balance is : <font class="text-success text-capitalize">&#8377;<%=request.getAttribute("balance")%></font></p>
  <p class="lead">
    <a class="btn btn-primary btn-lg" href="DisplayName.jsp" role="button">Home</a>
  </p>
</div>
<form method="post" action="view.do">
	<INPUT TYPE="submit" value="ViewBalance" hidden>

...
<%String ac = request.getParameter("rec");%>
...
<div class="container">
	<div class="row justify-content-md-center" >
		   <FORM  name="myform" method="POST" ACTION="money.do" style="margin-top: 80px;">
		<TABLE class="table table-striped table-dark">
				<TR>
			<TD colspan="2" align="center"><h2>Payment Gateway</h2></TD>
			</TR>
			<TR>
	<TD>To Account Number:</TD>
	
	<TD><INPUT  class="form-control" TYPE="text" placeholder="SBI-123456789" NAME="ac" value="<%=ac%>" disabled ></TD>
</TR>
<TR>
	<TD>Amount in Rupees (&#8377) :</TD>
	<TD><INPUT class="form-control" TYPE="number" placeholder="1000"  NAME="amt" value="<%=amt%>" disabled></TD>
</TR>
<TR>
	<TD>Description:</TD>
	<TD><TEXTAREA class="form-control"   placeholder="Optional" NAME="add"  value="" disabled><%=add%></TEXTAREA></TD>
</TR>
<TR>
	<TD>Enter OTP sent to your email:</TD>
	<TD><input type="text" NAME="otp"  placeholder="6 - Digit Number" class="form-control"  maxlength="6"   minlength="6" id="otp" required></input></TD>
</TR>
			<TR>
			...
			<tr>
				<td colspan="2" align="center">
					...
					onclick=
									...
									session.setAttribute("rec", ac);
									session.setAttribute("amt", amt);
									session.setAttribute("add", add);
									%>" 
					class="btn btn-primary btn-lg" value="Transfer">Transfer</Button>
				</td>
				</tr>
				<TR>

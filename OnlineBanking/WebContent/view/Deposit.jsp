...
<div class="container">
	<div class="row justify-content-md-center" >
		...
		<TABLE class="table table-striped table-dark">
				<TR>
			<TD colspan="2" align="center"><h2>Deposit Money</h2></TD>
			</TR>
			<TR>
...
<TR>
	<TD>Deposit Amount in Rupees (&#8377) :</TD>
	<TD><INPUT class="form-control" TYPE="number" placeholder="1000" NAME="amt" required></TD>
			...
			<tr>
				<td colspan="2" align="center">
					<Button type="submit" name="submit"   class="btn btn-primary btn-lg" value="Deposit">Deposit</Button>
				</td>
				</tr>
				<TR>

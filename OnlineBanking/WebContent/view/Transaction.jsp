...
<div class="container">
	<div class="row justify-content-md-center" >
		   <FORM  name="myform" method="POST" ACTION="otp.do" style="margin-top: 80px;">
		<TABLE class="table table-striped table-dark">
				<TR>
			<TD colspan="2" align="center"><h2>Transfer Money</h2></TD>
			</TR>
			<TR>
	<TD>To Account Number:</TD>
	<TD><INPUT  class="form-control" TYPE="text" placeholder="SBI-123456789" NAME="rec" required></TD>
</TR>
<TR>
...
<TR>
	<TD>Description:</TD>
	<TD><TEXTAREA class="form-control" NAME="add"  placeholder="Optional"></TEXTAREA></TD>
</TR>
			<TR>
			...
			<tr>
				<td colspan="2" align="center">
					<Button type="submit" name="submit"   class="btn btn-primary btn-lg" value="Transfer">Transfer</Button>
				</td>
				</tr>
				<TR>
